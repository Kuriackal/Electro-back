...
exports.createOrder= async(req,res)=>{
    // console.log("createOrderReq",req)
...
//decrement the quantity after purschse succesful and increament sold
...
exports.createCashOrder= async(req,res)=>{
    ...
    //if COD is true,create order with status of cash on delivry
